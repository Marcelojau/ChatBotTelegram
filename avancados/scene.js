...
bot.start(ctx => {
    ...
    ctx.reply(`Ente com /echo ou /soma para iniciar...`)
...
sumScene.enter(ctx => ctx.reply('Saindo em Sum Scene'))

sumScene.use(async (ctx, next) => {
    await ctx.reply('Voce está em Soma Scene, escreva número para soma')
